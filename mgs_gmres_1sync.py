...
# Low-Synchronization MGS-GMRES implementation
def MGS_GMRES_1SYNC(A, b, x0, max_iter, tol):
    ...
    for k in range(max_iter):
        ...
        # Arnoldi process with modified Gram-Schmidt with 1 synchronization
        w = A @ V[:, k]
        h = np.dot(V[:, :k+1].T, w)
...
if __name__ == "__main__":
    ...
    # Solve the linear system using LS-MGS-GMRES
    x, timings, mpi_allreduce_count, iterations = MGS_GMRES_1SYNC(A, b, x0, max_iter, tol)
